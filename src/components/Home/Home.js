  ...
  <main>
    <section className="container d-flex justify-content-center">
        ...
        <div className="row ">
            ...
            <div className="col-12 d-flex flex-row align-items-center">
              <div className="col-4 my-5">
                <img src="https://user-images.githubusercontent.com/44485081/57424915-fa728b80-71de-11e9-9e9e-30d543a44862.png" alt="dinero"></img>
                <p className="col-10 text-content text-center">Podrás solicitar préstamos accesibles sin tantos papeleos.</p>
              </div>
              <div className=" col-4 my-5">
                <img src="https://user-images.githubusercontent.com/44485081/57424933-09593e00-71df-11e9-81c2-bd90c42a7d55.png" alt="dinero"></img>
                <p className="col-10 text-content text-center">Encontrarás colaboradores y proveedores de confianza para tu negocio.</p>
             </div>
                <div className=" col-4 my-5">
                  <img src="https://user-images.githubusercontent.com/44485081/57424956-183ff080-71df-11e9-83be-ca2fd7e644be.png" alt="dinero"></img>
     ...
     <section className="container my-5">
        <div className="row">
          <div className="col-6">
          <img className="img-links" src="https://user-images.githubusercontent.com/44485081/57427115-20e8f480-71e8-11e9-90e8-38c129433b3e.jpg" alt="prestamo"></img>
          </div>
        ...
        <div className="d-flex flex-wrap-reverse">
         ...
         <div className="col-6">  
             <img className="img-links margin-r" src="https://user-images.githubusercontent.com/44485081/57427156-5d1c5500-71e8-11e9-9db5-4f5c9a1bbcfd.jpg" alt="contactos"></img>
            </div>
         </div>   


         <div className="col-6">
            <img className="img-links" src="https://user-images.githubusercontent.com/44485081/57427184-78876000-71e8-11e9-8292-e8742e856d6c.png" alt="crece"></img>
          </div>
